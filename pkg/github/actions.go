...
func ActionsList(t translations.TranslationHelperFunc) registry.ServerTool {
	tool := NewTool(
		ToolsetMetadataActions,
		mcp.Tool{
			Name: "actions_list",
...
func ActionsGet(t translations.TranslationHelperFunc) registry.ServerTool {
	tool := NewTool(
		ToolsetMetadataActions,
		mcp.Tool{
			Name: "actions_get",
...
func ActionsRunTrigger(t translations.TranslationHelperFunc) registry.ServerTool {
	tool := NewTool(
		ToolsetMetadataActions,
		mcp.Tool{
...
func ActionsGetJobLogs(t translations.TranslationHelperFunc) registry.ServerTool {
	tool := NewTool(
		ToolsetMetadataActions,
		mcp.Tool{
			Name: "get_job_logs",
